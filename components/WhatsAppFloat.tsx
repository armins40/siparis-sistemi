...
export default function WhatsAppFloat({ whatsappNumber = '905535057059' }: WhatsAppFloatProps) {
  const pathname = usePathname();
  const hideOnPaths = pathname?.startsWith('/m/') || pathname?.startsWith('/dashboard');
