  ...
  useEffect(() => {
    ...
    async function loadProducts() {
      try {
        ...
        const apiUrl = 'https://www.siparis-sistemi.com/api/products'
        console.log('[Menu Page] Fetching from:', apiUrl)
        ...
        console.log('[Menu Page] Response status:', response.status)
        ...
        console.log('[Menu Page] Data received:', Array.isArray(data) ? `${data.length} items` : typeof data)
