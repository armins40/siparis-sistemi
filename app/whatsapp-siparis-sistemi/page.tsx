...
export default function WhatsAppSiparisPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center">
        ...
        <p className="text-xl md:text-2xl mb-8 text-gray-600">
          QR veya linkle dijital menü paylaşın. Müşteri menüden seçer, adresini WhatsApp’tan gönderir. Siparişler sizde listelenir, konumu kuryeye yollarsınız. Komisyonsuz.
        </p>
