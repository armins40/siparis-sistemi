...
export default async function KasapSiparisPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      />
      <MarketingHeader
        bannerTitle="Kasap Sipariş Sistemi"
        bannerSubtitle="WhatsApp ile sipariş alın. Müşteri menüden seçer, adresini gönderir. Tek ekranda tüm siparişler."
