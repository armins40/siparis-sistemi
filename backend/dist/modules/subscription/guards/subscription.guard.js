...
let SubscriptionGuard = class SubscriptionGuard {
    ...
    async canActivate(context) {
        ...
        const canAccess = await this.subscriptionService.canAccess(tenantId);
        if (!canAccess) {
            throw new common_1.ForbiddenException('Subscription expired or inactive. Please renew your subscription.');
        }
        return true;
    }
};
